...
```{r}
mutate(flights, uaflight= (flights$carrier=='UA'), aaflight= (flights$carrier=='AA')) |>
  mutate(finedep= ifelse(uaflight, 75, 100) * flights$dep_delay/60) |>
  mutate(finearr= ifelse(aaflight, 150, 200) * flights$arr_delay/60) |>
