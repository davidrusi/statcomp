...
Reproduce two examples of your choice from the [plotly gallery](https://plotly.com/r)
...
tm_shape(nz) +
  tm_fill("Median_income", breaks= c(0,25000,30000,35000)) +
  tm_polygons()
...
esp= sf::st_as_sf(esp) #convert to class sf
...
esp2= sf::st_as_sf(esp2) #convert to class sf
...
library(shiny)
library(dplyr)  #dataset starwars

ui= fluidPage(  #specify user interface
  
  selectInput("color", label="Color", choices= unique(starwars$skin_color)), #dropdown menu
